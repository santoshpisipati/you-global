...
namespace YG_DataAccess
{
    public class CommonDataAccess
    {
        ...
        {
            //string sql = "select c.countryid,c.name,l.locationid, l.name as locationname,s.sublocationid,s.sublocation,ss.subsublocationid,ss.name as subsublocation from countries c left join locations l on c.countryid=l.countryid " +
            //             " left join locationsub s on s.locationid=l.locationid left join locationsub_subs ss on ss.sublocationid=s.sublocationid " +
            //             "where c.name like concat('%',?keyword,'%') or l.name like concat('%',?keyword,'%') or s.sublocation like concat('%',?keyword,'%') or ss.name like concat('%',?keyword,'%')";
            ...
            string sql = "select * from(" +
                ...
                //" union select  vl.countryid,vl.name,vl.locationid, vl.locationname as locationname,vl.sublocationid,vl.sublocation,vl.subsublocationid,vl.subsublocation as subsublocation,g.location_groupid,g.groupname " +
