    ...
    public abstract class BaseController : Controller
    {
        ...
        protected bool ProcessUpload()
        {
            ...
            try
            {
                ...
                string str6 = ConfigurationManager.AppSettings.Get(str + ".emailName") ?? (ConfigurationManager.AppSettings.Get("default.emailName") ?? "You Global Admin");
            ...
            catch (Exception exception)
            {
                ...
                {
                    From = new MailAddress(address, displayName),
                    Subject = "You Global Site Error - Contact Us",
