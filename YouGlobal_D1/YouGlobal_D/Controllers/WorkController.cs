...
namespace YG_MVC.Controllers
{
    ...
    {
        //private readonly IJobPostingService _jobPostingService = ((IJobPostingService)HttpContext.Current.Application["JobPostingService"]);

        public ActionResult ApplyOnline(string reference)
        {
            JobApplyModel model = new JobApplyModel();
            Job obj = new Job();
            JobInfo info = obj.GetJobInfoByReferenceNo(reference);
        ...
        //public ActionResult SearchJobDescription()
        //{
        //    long num;
        //    string s = base.Request["jobId"];
        //    if (long.TryParse(s, out num) && (num >= 0L))
        //    {
        //        return base.View("JobDescription", this._jobPostingService.FindJobPostingByExternalId("AdLogic", num));
        //    }
        //    return base.View("JobDescription", this._jobPostingService.FindJobPostingByExternalReference("AdLogic", s));
        //}
